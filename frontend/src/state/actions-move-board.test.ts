...
vi.mock('./board-store', () => ({
  ...
  selectItem: (id: string) => { mockSelectedItemId.current = id; },
  clearSelectedItem: () => { mockSelectedItemId.current = null; },
  initSelectedItemFromUrl: vi.fn(),
  initActiveViewFromUrl: vi.fn(),
  initUpcomingBoardFilter: vi.fn(),
